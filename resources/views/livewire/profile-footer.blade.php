<div>
    <div class="grid grid-cols-2 gap-10 mt-10 px-10 py-2 border-b-2">
        <div class="text-center {{ $show == 'tab1' ? 'border-b-2 border-red-400 text-red-500' : null}}">
            <a class="foucs:outline-none cursor-pointer" wire:click="toggle(1)">Question Posts</a>
        </div>
        <div class="text-center {{ $show == 'tab2' ? 'border-b-2 border-red-400 text-red-500' : null}}">
            <a class="foucs:outline-none cursor-pointer" wire:click="toggle(2)">About</a>
        </div>
   </div>
   <div>
       @if ($show == 'tab1')
