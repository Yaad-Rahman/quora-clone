<div class="border shadow mt-5 p-5">
    <div class="flex">
        ...
        <h5>Sample Username</h5>
        <h5 class="ml-5 text-xs text-gray-500 pt-1">December 19</h5>
    </div>
    <div class="mt-2">
        <h5 class="text-lg font-bold">Sample question of the user .. how quora works tell me ?</h5>
        <img class="mt-5" src="{{asset('/post.jpg')}}" alt="post_img" width="500">
    </div>
    <footer class="mt-2">
        <div class="flex ">
            <div class="flex mr-10 bg-gray-200 p-1 rounded">
                <div class="flex">
                    <svg width="24px" height="24px" viewBox="0 0 24 24"><g id="upvote" class="icon_svg-stroke icon_svg-fill" stroke-width="1.5" stroke="#666" fill="none" fill-rule="evenodd" stroke-linejoin="round"><polygon points="12 4 3 15 9 15 9 20 15 20 15 15 21 15"></polygon></g>
                    </svg>
                    <span>56</span>
                </div>
                <div class="flex ml-2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24"><g id="downvote" class="icon_svg-stroke icon_svg-fill" stroke="#666" fill="none" stroke-width="1.5" fill-rule="evenodd" stroke-linejoin="round"><polygon transform="translate(12.000000, 12.000000) rotate(-180.000000) translate(-12.000000, -12.000000) " points="12 4 3 15 9 15 9 20 15 20 15 15 21 15"></polygon></g>
                    </svg>
                    <span>2</span>
                </div>  
            </div>
